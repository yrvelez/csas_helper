...
from csas.views import dynamic_issue_openai, dynamic_issue_llama, view_issues, update_rating, select_questions_simulation, main_page, fetch_openai_completion, upload_completion, view_db_content, fetch_llama_completion, save_session_data, upload_completions, survey_view, update_ratings, view_user_content, delete_entry, edit_entry, thank_you, submit_survey
...
urlpatterns = [
    ...
    path('dynamic-issue-llama/',
         dynamic_issue_llama,
         name='dynamic_issue_llama'),
    ...
    path('fetch-llama-completion/<str:issue>/<str:prompt>',
         fetch_llama_completion,
         name='fetch_llama_completion'),
